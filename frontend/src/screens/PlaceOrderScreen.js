...
const PlaceOrderScreen = ({history}) => {
    ...
    //added order._id - probably gonna be mistake

    const placeOrderHandler = () => {
        dispatch(createOrder({
            orderItems: cart.cartItems,
            shippingAdrress: cart.shippingAdrress,
                    ...
                    <ListGroup variant='flush'>
                        <ListGroup.Item>
                            ...
                            <p>
                                ...
                                {cart.shippingAdrress.adrress} , {cart.shippingAdrress.city} , {' '} {cart.shippingAdrress.postalCode} , {' '} {cart.shippingAdrress.country}
                            </p>
                        </ListGroup.Item>
                        <ListGroup.Item>
