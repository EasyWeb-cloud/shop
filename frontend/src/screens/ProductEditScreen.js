...
const ProductEditScreen = ({match , history}) => {
    ...
    const {loading: loadignUpdate , error: errorUpdate , success: successUpdate} = productUpdate
    ...
    const submitHandler = (e) => {
        e.preventDefault()
        dispatch(updateProduct({_id: productId , name , price , image , description , countInStock , brand , category}))
    }
