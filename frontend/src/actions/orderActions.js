...
export const payOrder = (orderId , paymentResult) => async (dispatch , getState) => {
    try {
        ...
        dispatch({type: ORDER_PAY_FAIL , payload: error.response && error.response.data.message ? error.response.data.message : error.response})
    }
}
...
export const deliverOrder = (order) => async (dispatch , getState) => {
    try {
        ...
        dispatch({type: ORDER_DELIVER_FAIL , payload: error.response && error.response.data.message ? error.response.data.message : error.response})
    }
}
...
export const listOrders = () => async (dispatch , getState) => {
    try {
        ...
        dispatch({type: ORDER_LIST_FAIL , payload: error.response && error.response.data.message ? error.response.data.message : error.response})
    }
}